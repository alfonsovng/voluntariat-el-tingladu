...
\copy tmp_shifts(task_name, day, description, slots, reward, assignations) from '/docker-entrypoint-initdb.d/csv/shifts.csv' delimiter ',' csv header;
...
insert into shifts (task_id, day, description, slots, reward, assignations)
select task_id, day, description, slots, reward, assignations from tmp_shifts;
